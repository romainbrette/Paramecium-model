...
x2, y2 = M.x[0]/um, M.y[0]/um
orientation2 = M.orientation[0]
...
writer = imageio.get_writer('fig7_wall_slow.mp4', fps=100.)
...
ax_trajectory.plot(x2,y2,'r')
ax_trajectory.plot(x,y,'k')

#ax_trajectory.plot([x_wall/um, x_wall/um], (500,1400), 'k--') # wall
ax_trajectory.fill_betweenx(y=(500,1400), x1=1000, x2=1300, color='k', alpha=0.1)
ax_trajectory.fill_betweenx(y=(500,1400), x1=1300, x2=1400, color='r', alpha=0.1)
...
try:
    ...
    plot_cell(ax_trajectory, x[i1], y[i1], scale=120, theta=orientation[i1], color='k') # why is the angle apparently wrong?
except:
    pass
try:
    i1 = ((y2<600) | (y2>1300)).nonzero()[0][0]
    plot_cell(ax_trajectory, x2[i1], y2[i1], scale=120, theta=orientation2[i1], color='r') # why is the angle apparently wrong?
except:
    pass
...
savefig('fig7_wall_slow.png', dpi=300)
