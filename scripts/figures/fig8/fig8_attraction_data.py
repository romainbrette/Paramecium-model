'''
Simulates 100 trajectories on a torus with a central attractive stimulus.
...
# Save data
savez_compressed('attraction.npz',x=x,y=y,z=z,orientation=orientation, v=M2.v[0:10]/mV, I=M2.I[0:10]/nA, Ca=M2.Cai_cilia[0:10]/molar)

# Movie
background=1-0.1*obstacle
writer = imageio.get_writer('attraction.mp4', fps=30.)
